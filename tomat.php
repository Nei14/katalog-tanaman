  ...
  <div class="container">
    <div class="row align-items-center g-5">
      ...
      <div class="col-lg-7" data-aos="fade-left">
        ...
        <p class="plant-desc">Tomat kecil berwarna merah atau kuning yang rasanya manis-asam. Mudah ditanam di galon dan bisa sekaligus jadi tanaman hias yang cantik.</p>
  ...
  <div class="container">
    ...
    <div class="tab-content" data-aos="fade-up" data-aos-delay="100">
      <div class="tab-pane fade show active" id="manfaat">
        <div class="row g-3">
          <div class="col-md-6"><div class="benefit-card"><i class="bi bi-heart-pulse"></i><div><strong>Kaya Vitamin</strong><p>Mengandung vitamin C dan likopen yang bagus untuk jantung dan kulit.</p></div></div></div>
          <div class="col-md-6"><div class="benefit-card"><i class="bi bi-droplet-half"></i><div><strong>Menyegarkan</strong><p>Kandungan airnya tinggi, cocok dimakan langsung sebagai camilan sehat.</p></div></div></div>
          <div class="col-md-6"><div class="benefit-card"><i class="bi bi-eye"></i><div><strong>Baik untuk Mata</strong><p>Kandungan luteinnya membantu menjaga kesehatan mata sehari-hari.</p></div></div></div>
          <div class="col-md-6"><div class="benefit-card"><i class="bi bi-palette2"></i><div><strong>Cantik di Rumah</strong><p>Buahnya yang merah-kuning juga mempercantik tampilan rumah.</p></div></div></div>
        </div>
      </div>
      <div class="tab-pane fade" id="perawatan">
        <div class="row g-3">
          <div class="col-md-6"><div class="care-card"><div class="care-icon"><i class="bi bi-droplet-fill"></i></div><div class="care-body"><h5>Penyiraman</h5><p>Siram <strong>1&ndash;2 kali sehari</strong>. Tanah harus tetap lembap, tapi jangan sampai tergenang.</p></div></div></div>
          <div class="col-md-6"><div class="care-card"><div class="care-icon"><i class="bi bi-sun-fill"></i></div><div class="care-body"><h5>Sinar Matahari</h5><p>Butuh <strong>sinar matahari langsung</strong> minimal 6 jam sehari. Kurang cahaya, buah jadi sedikit.</p></div></div></div>
          <div class="col-md-6"><div class="care-card"><div class="care-icon"><i class="bi bi-layers-fill"></i></div><div class="care-body"><h5>Tanah di Galon</h5><p>Lubangi bawah galon 5&ndash;6 titik. Isi dengan campuran <strong>tanah : pupuk : sekam (1:1:1)</strong>. Pasang tongkat penyangga sejak awal.</p></div></div></div>
          <div class="col-md-6"><div class="care-card"><div class="care-icon"><i class="bi bi-scissors"></i></div><div class="care-body"><h5>Pangkas Tunas Liar</h5><p>Potong tunas kecil di ketiak daun agar buah tumbuh lebih banyak dan besar.</p></div></div></div>
        </div>
      </div>
      <div class="tab-pane fade" id="panen">
        <div class="harvest-info">
          <div class="harvest-timeline">
            ...
            <div class="timeline-item"><div class="tl-dot">2</div><div class="tl-content"><h6>Minggu 3&ndash;5: Pindah ke Galon</h6><p>Setelah bibit punya 4&ndash;6 daun, pindahkan ke galon. Pasang tongkat penyangga dari awal.</p></div></div>
